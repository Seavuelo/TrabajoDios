...
public class modificarLibro extends javax.swing.JFrame {
    ...
    private void bt_grabarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_grabarActionPerformed
        // TODO add your handling code here:
            ...
            try{
           String autor = this.tf_autor.getText().trim();
           String titulo = this.tf_titulo.getText().trim();
           String genero = this.tf_genLiterario.getText().trim();
           
           if (autor.isEmpty()) {
            javax.swing.JOptionPane.showMessageDialog(this, "Asegúrese de llenar los campos correctamente");
        ...
        if (Registro.modificarLibro(libro)) {
           ...
           javax.swing.JOptionPane.showMessageDialog(this, "Asegurese de llenar los campos correctamente");}
